...
export default function NewMarchePage() {
    ...
    useEffect(() => {
        const fetchRubriques = async () => {
            try {
                // Assuming there's an API endpoint to fetch rubriques
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : "Une erreur s'est produite lors de la création du marché"
            setError(
                                    ...
                                    {formData.decomptes.map((decompte, index) => (
                                        <div key={index} className="relative rounded-md border p-4">
                                            ...
                                            <div className="grid gap-4 md:grid-cols-2">
                                                ...
                                                <div className="space-y-2">
                                                    <Label htmlFor={`decompte-${index}-dateExecution`}>Date d&pos;Exécution</Label>
                                                    <Input
